...
const productsData = [
  { id: "meat1", name: 'Prawn', price: 60, rating: 4.5, image: meat1 },
  { id: "meat2", name: 'Beaf', price: 100, rating: 4.1, image: meat2 },
  { id: "meat3", name: 'Chicken', price: 40, rating: 4.3, image: meat3 },
  { id: "meat4", name: 'Leg Piece', price: 80, rating: 4.6, image: meat4 },
  { id: "meat5", name: 'Fish', price: 30, rating: 4.7, image: meat5 },
  { id: "meat6", name: 'small chickens', price: 50, rating: 4.5, image: meat6 },
  { id: "meat7", name: '2 Fish Pieces', price: 90, rating: 4.3, image: meat7 },
  { id: "meat8", name: 'Mutton', price: 70, rating: 4.4, image: meat8 },
];
                ...
                <div key={product.id} className="col-md-4 mb-4">
                  <div className="card h-100">
                    <img
                      ...
                      onClick={() => navigate(`/product/meat-seafood/${product.id}`)}
