...
const productsData = [
  { id: "frozen1", name: 'Freezed Apple', price: 60, rating: 4.5, image: frozen1 },
       ...
       { id: "frozen5", name: 'Freezed Fish', price: 30, rating: 4.7, image: frozen5 },
       { id: "frozen6", name: 'Mango Cream', price: 50, rating: 4.5, image: frozen6 },
       { id: "frozen7", name: 'Ice Bar', price: 90, rating: 4.3, image: frozen7 },
       { id: "frozen8", name: 'Cone Ice Cream', price: 70, rating: 4.4, image: frozen8 },
];
                ...
                <div key={product.id} className="col-md-4 mb-4">
                  <div className="card h-100">
                    <img
                      ...
                      onClick={() => navigate(`/product/frozen-food/${product.id}`)}
