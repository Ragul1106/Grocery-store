...
import egg1 from '../assets/images/diary cate 1.png';
import egg2 from '../assets/images/diary cate 2.png';
import egg3 from '../assets/images/diary cate 3.png';
import egg4 from '../assets/images/diary cate 4.png';
import egg5 from '../assets/images/diary cate 5.png';
import egg6 from '../assets/images/diary cate 6.png';
import egg7 from '../assets/images/diary cate 7.png';
...
const productsData = [
  { id: "diary1", name: 'Egg', price: 60, rating: 4.5, image: egg1 },
       ...
       { id: "diary5", name: 'Cheese Egg', price: 30, rating: 4.7, image: egg5 },
       { id: "diary6", name: 'Cheese', price: 50, rating: 4.5, image: egg6 },
       { id: "diary7", name: 'Cut Cheese', price: 90, rating: 4.3, image: egg7 },
                ...
                <div key={product.id} className="col-md-4 mb-4">
                  <div className="card h-100">
                    <img
                      ...
                      onClick={() => navigate(`/product/dairy-eggs/${product.id}`)}
